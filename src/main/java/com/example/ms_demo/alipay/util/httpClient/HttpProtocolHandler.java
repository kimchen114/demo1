package com.example.ms_demo.alipay.util.httpClient;
...
public class HttpProtocolHandler {
	...
	public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath)
		...
		try {
			...
			if (request.getResultType().equals(AlipayConfig.STRING)) {
				response.setStringResult(method.getResponseBodyAsString());
			} else if (request.getResultType().equals(AlipayConfig.BYTES)) {
